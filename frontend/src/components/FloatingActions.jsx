  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Догори"
        className={`fixed bottom-24 md:bottom-6 left-4 md:left-6 z-40 w-11 h-11 rounded-full bg-white/90 backdrop-blur border border-[#e6dfd5] shadow-lg hover:bg-[#1a1a1a] hover:text-white text-[#1a1a1a] flex items-center justify-center transition-all duration-300 ${
      ...
      {/* Floating contact stack — desktop only (mobile uses MobileCallBar) */}
      <div className="hidden md:flex fixed bottom-5 right-5 sm:bottom-6 sm:right-6 z-40 flex-col items-end gap-3">
        {/* Expanded items */}
        <div
