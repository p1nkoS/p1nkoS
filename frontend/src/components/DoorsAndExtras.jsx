...
import { ArrowRight, Bug, PanelTop, PanelsTopLeft, CloudRain, Layers3, ShieldCheck, Cog, Palette, ArrowLeftRight } from "lucide-react";
import { getProductsByCategory } from "../data/products";
import SmartImage from "./SmartImage";

const ICON_MAP = {
  "antimoskitni": Bug,
  "hpl-paneli": PanelsTopLeft,
  "pidvikonnya": PanelTop,
  "rolety": ShieldCheck,
  "vidlyvy": CloudRain,
  "furnitura": Cog,
  "sklopakety": Layers3,
      ...
      <section id="additional" className="section-pad bg-white">
        <div className="max-w-[1600px] mx-auto px-5 md:px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-5">
            {additional.map((p) => {
              const Icon = ICON_MAP[p.slug] || PanelsTopLeft;
              return (
                <Link
                  key={p.slug}
                  to={`/product/${p.slug}`}
