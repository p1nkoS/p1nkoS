...
import { FaTelegramPlane, FaViber, FaInstagram, FaFacebookF } from "react-icons/fa";
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 mb-14">
          <div className="col-span-2 lg:col-span-2">
            ...
            <div className="flex flex-wrap gap-3">
              <a href={SITE_CONFIG.telegram} target="_blank" rel="noreferrer" data-testid="footer-telegram" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#0088cc] flex items-center justify-center transition-colors" aria-label="Telegram" title="Telegram">
                <FaTelegramPlane size={16} />
              </a>
              <a href={SITE_CONFIG.viber} data-testid="footer-viber" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#7360F2] flex items-center justify-center transition-colors" aria-label="Viber" title="Viber">
                <FaViber size={16} />
              </a>
              <a href={SITE_CONFIG.instagram} target="_blank" rel="noreferrer" data-testid="footer-instagram" className="w-10 h-10 rounded-full bg-white/5 hover:bg-gradient-to-br hover:from-[#E1306C] hover:to-[#F77737] flex items-center justify-center transition-colors" aria-label="Instagram" title="Instagram">
                <FaInstagram size={16} />
              </a>
              <a href={SITE_CONFIG.facebook} target="_blank" rel="noreferrer" data-testid="footer-facebook" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#1877F2] flex items-center justify-center transition-colors" aria-label="Facebook" title="Facebook">
                <FaFacebookF size={16} />
              </a>
              <a href={SITE_CONFIG.mailto} data-testid="footer-email" className="w-10 h-10 rounded-full bg-white/5 hover:bg-[#FF5722] flex items-center justify-center transition-colors" aria-label="Email" title="Email">
                <Mail size={16} />
              </a>
            </div>
          </div>
