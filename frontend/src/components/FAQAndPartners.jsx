          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="relative">
              <div className="rounded-3xl overflow-hidden h-[480px] md:h-[560px]">
                <SmartImage src="https://viknaroff.ua/wp-content/uploads/2024/05/banner.webp" alt="Viknar'off виробництво" width={1000} className="w-full h-full transition-transform duration-1000 hover:scale-105" />
              </div>
